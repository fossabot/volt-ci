...
class ThreadingTCPServer(socketserver.ThreadingMixIn, socketserver.TCPServer):
    ...
    :cvar runners: keeps track of test runner pool
    :cvar dead: indicate to other threads that we ain't alive
    :cvar dispatched_commits: keeps track of commits we have dispatched
    :cvar pending_commits: keeps track of commits we have yet to dispatch
    """
